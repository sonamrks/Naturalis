...
public class CartItemsPanel extends javax.swing.JPanel implements Observer {
     ...
     */
    public CartItemsPanel(CustomerUI customerUI, CartItemsController cartItemsController, Integer machineID) {
        initComponents();  
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        customerUI.getItemController().increaseItemCount(Integer.valueOf(hiddenTextField.getText()),machineID);
